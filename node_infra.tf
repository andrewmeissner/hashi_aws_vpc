module "infra_nodes" {
  ...
  security_group_ids        = ["${aws_security_group.ssh.id}", "${aws_security_group.hashi.id}", "${aws_security_group.rundeck.id}", "${aws_security_group.registry.id}", "${aws_security_group.nifi.id}"]
